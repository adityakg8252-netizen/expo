...
const withWidgetSourceFiles = (config, { widgets, bundleIdentifier, targetName, onFilesGenerated }) => (0, config_plugins_1.withDangerousMod)(config, [
    'ios',
    async (config) => {
        ...
        fs.writeFileSync(entitlementsPath, plist_1.default.build({}));
